...
public class ScoreContent {
	...
	static {
		...
		sensitive_word.add(new Pair<Pattern, Double>(Pattern.compile(".*赚钱.*"), 2.0));
		sensitive_word.add(new Pair<Pattern, Double>(Pattern.compile(".*奖金.*"), 2.0));
		sensitive_word.add(new Pair<Pattern, Double>(Pattern.compile(".*额度.*"), 2.0));
		sensitive_word.add(new Pair<Pattern, Double>(Pattern.compile(".*免费.*"), 2.0));
		sensitive_word.add(new Pair<Pattern, Double>(Pattern.compile(".*发放.*"), 2.0));
		sensitive_word.add(new Pair<Pattern, Double>(Pattern.compile(".*下发.*"), 2.0));
		sensitive_word.add(new Pair<Pattern, Double>(Pattern.compile(".*登陆.*"), 2.0));
		sensitive_word.add(new Pair<Pattern, Double>(Pattern.compile(".*登录.*"), 2.0));
